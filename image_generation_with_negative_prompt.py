...
for prompt, neg_prompt in zip(tileset_prompts['prompt'], tileset_prompts['neg_prompt']):
    # Generate the image
    answers = stability_api.generate(
        ...
        width=320,  # Generation width, defaults to 512 if not included.
        height=320,  # Generation height, defaults to 512 if not included.
