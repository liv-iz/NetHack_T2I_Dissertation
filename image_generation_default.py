...
tileset_prompts = pd.read_csv(os.join(file_location, '/tileset_gpt4_default.csv'))
...
for prompt in tileset_prompts['GPT-4 description'].sample(10):
    # Generate the image
    answers = stability_api.generate(
        prompt=prompt,
        seed=seed_number,  # If a seed is provided, the resulting generated image will be deterministic.
    ...
    for resp in answers:
        for artifact in resp.artifacts:
            ...
            if artifact.type == generation.ARTIFACT_IMAGE:
                ...
                img.save(f"nethack_tileset/Second Run- default/{filename}_{artifact.seed}.png")  # Save our generated images with the first two words of the prompt as the filename.
